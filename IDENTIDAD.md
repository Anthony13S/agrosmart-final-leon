...
|:---:|-----------|-----------------|----------|
| — | `NN` | los 2 últimos dígitos de mi cédula | 93 |
| 1 | Nombre de la tabla | `tbl_productos_base_` + `NN` | tbl_productos_base_93 |
| 2 | Puerto | `81` + `NN` | 8193 |
| 3 | Categoría | según el **último dígito** (tabla de abajo) | 3 |
| — | Audiencia para el prompt de IA | según la categoría | Café |
...
- **Enlace al video (5 min, cámara + pantalla):** https://drive.google.com/file/d/1liYsVYd5TAvqS5c3eFb1--uKqKU9wCMy/view?usp=sharing
- **Plataforma:**   DRIVE                
